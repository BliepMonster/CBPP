...
public record BitwiseXorInstruction(UniqueVariable v1, UniqueVariable v2, UniqueVariable result) implements Instruction {
    @Override
    public <R> R accept(InstructionVisitor<R> visitor) {
        return visitor.visitBitwiseXorInstruction(this);
    }
}
